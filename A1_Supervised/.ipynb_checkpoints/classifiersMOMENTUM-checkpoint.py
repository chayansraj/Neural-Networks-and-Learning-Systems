...
def trainSingleLayer(XTrain, DTrain, XTest, DTest, W0, numIterations, learningRate, momentum):
    """ TRAINSINGLELAYER
...
def trainMultiLayer(XTrain, DTrain, XTest, DTest, W0, V0, numIterations, learningRate, momentum):
    """ TRAINMULTILAYER
